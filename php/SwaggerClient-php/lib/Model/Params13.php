 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Params13 implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'params_13';
    ...
    /**
     * Sets file_ids
     * @param int[] $file_ids The ID numbers of the files to be downloaded
     * @return $this
     */
     ...
     * @param string $specified_filename The name of the archive file that the Userfiles will be compressed into for downloading.
     * @return $this
     */
